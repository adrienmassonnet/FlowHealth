  ...
  return (
    <main>
      ...
      <section className="bg-white">
        <div className="max-w-[1200px] mx-auto px-6 py-12 md:py-20 grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center">
          <div className="space-y-6">
            <p className="text-xs tracking-[0.16em] uppercase text-[hsla(var(--color-secondary)/0.5)] font-medium">Our Mission</p>
      ...
      <section className="bg-[#1E185408]">
        <div className="max-w-[1200px] mx-auto px-6 py-12 md:py-20 grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-start">
          <div className="space-y-6 md:sticky md:top-28">
            <p className="text-xs tracking-[0.16em] uppercase text-[hsla(var(--color-secondary)/0.5)] font-medium">What We Believe</p>
            <h2 className="text-3xl md:text-4xl font-semibold tracking-[-0.02em] leading-tight">
          ...
          <ul className="space-y-5">
            {beliefs.map((b) => (
              <li key={b.text.slice(0, 40)} className="flex items-start gap-4 py-5 border-b border-[var(--color-border)] last:border-0">
                <span className="shrink-0 mt-0.5 w-6 h-6 rounded-full bg-[#1E1854] flex items-center justify-center">
                  <svg width="10" height="10" viewBox="0 0 10 10" fill="none">
                    <path d="M2 5l2.5 2.5 4-4" stroke="white" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </span>
                <p className="text-base text-[#1E1854] leading-relaxed font-medium">{b.text}</p>
              </li>
            ))}
          </ul>
        </div>
      ...
      <section className="bg-[#1E1854] py-20">
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="mb-14 space-y-2">
            <p className="text-xs tracking-[0.16em] uppercase text-white/40 font-medium">Non-Negotiables</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-white/10 border border-white/10 rounded-2xl overflow-hidden">
            {principles.map((p) => (
              <div key={p.number} className="bg-[#1E1854] p-8 space-y-4">
      ...
      <section className="bg-white">
        <div className="max-w-[1200px] mx-auto px-6 py-12 md:py-20 grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center">
          ...
          <div className="space-y-6">
            <p className="text-xs tracking-[0.16em] uppercase text-[hsla(var(--color-secondary)/0.5)] font-medium">The Standard</p>
            <h2 className="text-3xl md:text-4xl font-semibold tracking-[-0.02em] leading-tight">
