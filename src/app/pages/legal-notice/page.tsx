  ...
  return (
    <main className="max-w-4xl mx-auto px-6 py-24 space-y-10">
      ...
      <div className="space-y-3">
        ...
        <p className="text-xs text-[hsla(var(--color-secondary)/1)]">Required under Swiss and EU law · Last updated: 27 November 2025</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-[var(--color-border)]">

        {/* Company */}
        <div className="bg-[#F8F8F8] p-8 space-y-3">
          <h2 className="text-xs tracking-[0.1em] uppercase font-semibold">Company</h2>
          <div className="text-base text-[hsla(var(--color-secondary)/1)] leading-relaxed space-y-0.5">
        ...
        <div className="bg-[#F8F8F8] p-8 space-y-3">
          ...
          <p className="text-base text-[hsla(var(--color-secondary)/1)]">Adrien Massonnet</p>
        </div>
      ...
      <div className="space-y-3 border-t border-[var(--color-border)] pt-10">
        ...
        <div className="pt-4">
          <p className="text-base text-[hsla(var(--color-secondary)/1)]">Thank you for visiting flowhealth.ch</p>
        </div>
      </div>
