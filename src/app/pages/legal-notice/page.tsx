    ...
    <main className="max-w-4xl mx-auto px-6 py-24 space-y-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-[var(--color-border)]">
        ...
        <div className="bg-[#1E185408] p-8 space-y-3">
          ...
          <div className="text-sm text-[hsla(var(--color-secondary)/1)] leading-relaxed space-y-0.5">
        ...
        <div className="bg-[#1E185408] p-8 space-y-3">
          ...
          <p className="text-sm text-[hsla(var(--color-secondary)/1)]">Adrien Massonnet</p>
        </div>
      ...
      <div className="space-y-3 border-t border-[var(--color-border)] pt-10">
        ...
        <div className="pt-4">
          <p className="text-sm text-[hsla(var(--color-secondary)/1)]">Thank you for visiting flowhealth.ch</p>
        </div>
      </div>
