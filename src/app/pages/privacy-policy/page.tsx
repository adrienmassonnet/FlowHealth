  ...
  return (
    <main className="max-w-4xl mx-auto px-6 pt-20 pb-24 space-y-12">
            ...
            <tbody className="divide-y divide-[var(--color-border)]">
              {[
                ...
                <tr key={situation}>
                  ...
                  <td className="py-3 pr-5 text-sm text-[hsla(var(--color-secondary)/1)] align-top">{data}</td>
                  <td className="py-3 pr-5 text-sm text-[hsla(var(--color-secondary)/1)] align-top">{purpose}</td>
                  <td className="py-3 text-sm text-[hsla(var(--color-secondary)/1)] align-top">{basis}</td>
                </tr>
              ))}
            </tbody>
          </table>
            ...
            <tbody className="divide-y divide-[var(--color-border)]">
              {[
                ...
                <tr key={type}>
                  ...
                  <td className="py-3 text-sm text-[hsla(var(--color-secondary)/1)]">{period}</td>
                </tr>
              ))}
            </tbody>
          </table>
      ...
      <div className="space-y-4">
        ...
        <p className="text-sm text-[hsla(var(--color-secondary)/1)]">You have the right to:</p>
