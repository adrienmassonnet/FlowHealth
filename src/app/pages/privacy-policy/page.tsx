  ...
  return (
    <main className="max-w-4xl mx-auto px-6 pt-20 pb-24 space-y-12">
      ...
      <div className="space-y-3">
        ...
        <h1 className="flow-h1">Privacy policy</h1>
      ...
      {/* Section 1 */}
      <div className="space-y-3">
        <h2 className="flow-h4">1. Data Controller</h2>
      ...
      <div className="space-y-5">
        <h2 className="flow-h4">2. What personal data we collect and why</h2>
        <div className="overflow-x-auto">
          <table className="w-full text-base border-collapse">
            <thead>
              <tr className="border-b border-ink/[12.5%]">
                <th className="text-left py-3 pr-5 flow-label">Situation</th>
                <th className="text-left py-3 pr-5 flow-label">Data collected</th>
                <th className="text-left py-3 pr-5 flow-label">Purpose</th>
                <th className="text-left py-3 flow-label">Legal basis</th>
              </tr>
            </thead>
      ...
      {/* Section 3 */}
      <div className="space-y-3">
        <h2 className="flow-h4">3. Cookies &amp; tracking technologies</h2>
        <p className="text-sm font-semibold bg-gradient-to-r from-brand to-ink bg-clip-text text-transparent leading-relaxed">
      ...
      <div className="space-y-4">
        <h2 className="flow-h4">4. Who we share your data with</h2>
      ...
      {/* Section 5 */}
      <div className="space-y-4">
        <h2 className="flow-h4">5. International transfers</h2>
        <p className="text-sm font-semibold bg-gradient-to-r from-brand to-ink bg-clip-text text-transparent leading-relaxed">
      ...
      {/* Section 6 */}
      <div className="space-y-4">
        <h2 className="flow-h4">6. How long we keep your data</h2>
        <div className="overflow-x-auto">
          <table className="w-full text-base border-collapse">
            <thead>
              <tr className="border-b border-ink/[12.5%]">
                <th className="text-left py-3 pr-8 flow-label">Data type</th>
                <th className="text-left py-3 flow-label">Retention period</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-ink/[12.5%]">
              {[
      ...
      {/* Section 7 */}
      <div className="space-y-4">
        <h2 className="flow-h4">7. Your rights (Switzerland &amp; EU)</h2>
      ...
      {/* Section 8 */}
      <div className="space-y-3">
        <h2 className="flow-h4">8. Children</h2>
        <p className="text-sm font-semibold bg-gradient-to-r from-brand to-ink bg-clip-text text-transparent leading-relaxed">
      ...
      {/* Section 9 */}
      <div className="space-y-3">
        <h2 className="flow-h4">9. Security</h2>
        <p className="text-sm font-semibold bg-gradient-to-r from-brand to-ink bg-clip-text text-transparent leading-relaxed">
      ...
      {/* Section 10 */}
      <div className="space-y-3">
        <h2 className="flow-h4">10. Changes to this policy</h2>
        <p className="text-sm font-semibold bg-gradient-to-r from-brand to-ink bg-clip-text text-transparent leading-relaxed">
      ...
      <div className="space-y-4 border-t border-ink/[12.5%] pt-10">
        <h2 className="flow-h4">11. Contact us</h2>
