...
export default function ProductTopics({ ingredients }: { ingredients: Ingredient[] }) {
  return (
    <div className="bg-white">

      {/* The Ingredients */}
      <IngredientsAccordion variant="card" ingredients={ingredients.filter((ing) => ing.name.toLowerCase() !== 'stevia').map((ing) => ({ ...ing, description: getBenefit(ing.name) ?? ing.description }))} />
      ...
      <section className="border-t border-[#1E1854]/[0.06] bg-[#F8F8FC]">
        <div className="max-w-[1200px] mx-auto px-6 py-16 md:py-24">
          <div className="mb-10 md:mb-14 space-y-3 max-w-2xl">
            ...
            <p className="text-sm text-[hsla(var(--color-secondary)/0.65)] leading-relaxed">Most supplements target a single pathway. Flow is built around five interconnected cognitive systems — because memory, focus, stress, neuroplasticity, and recovery don't operate in isolation.</p>
          </div>
      ...
      <section className="border-t border-[#1E1854]/[0.06] bg-white">
        <div className="max-w-[1200px] mx-auto px-6 py-16 md:py-24">
          <div className="mb-10 md:mb-14 space-y-3 max-w-2xl">
            ...
            <p className="text-sm text-[hsla(var(--color-secondary)/0.65)] leading-relaxed">The ingredients on the label only matter if the process behind them is held to the same standard.</p>
          </div>
      ...
      <section className="border-t border-[#1E1854]/[0.06] bg-[#F8F8FC]">
        <div className="max-w-[1200px] mx-auto px-6 py-16 md:py-24">
          <div className="mb-10 md:mb-14 space-y-3 max-w-2xl">
            ...
            <p className="text-sm text-[hsla(var(--color-secondary)/0.65)] leading-relaxed">The supplement industry has a long list of common shortcuts. These are the ones we refuse to take.</p>
          </div>
