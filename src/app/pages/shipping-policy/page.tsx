  ...
  return (
    <main className="max-w-4xl mx-auto px-6 py-24 space-y-12">
      ...
      <div className="space-y-3">
        <p className="text-xs tracking-[0.16em] uppercase text-[hsla(var(--color-secondary)/1)]">Support</p>
            ...
            <tbody className="divide-y divide-[var(--color-border)]">
              {[
                ...
                <tr key={`${dest}-${value}`}>
                  ...
                  <td className="py-3 pr-6 text-sm text-[hsla(var(--color-secondary)/1)]">{value}</td>
                  <td className="py-3 pr-6 text-base font-medium">{cost}</td>
                  <td className="py-3 text-sm text-[hsla(var(--color-secondary)/1)]">{time}</td>
                </tr>
              ))}
            </tbody>
          </table>
        </div>
        <p className="text-xs text-[hsla(var(--color-secondary)/1)] leading-relaxed">
      ...
      <div className="space-y-4">
        ...
        <ul className="space-y-2 text-sm text-[hsla(var(--color-secondary)/1)] leading-relaxed">
        ...
        <p className="text-sm text-[hsla(var(--color-secondary)/1)]">All parcels are fully tracked and insured.</p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <p className="text-xs tracking-[0.08em] uppercase text-[hsla(var(--color-secondary)/1)] font-medium">Important for non-Swiss customers</p>
        <ul className="space-y-2 text-sm text-[hsla(var(--color-secondary)/1)] leading-relaxed">
        ...
        <p className="text-sm text-[hsla(var(--color-secondary)/1)]">We are not liable for parcels held or refused due to unpaid duties/taxes.</p>
      </div>
      ...
      <div className="space-y-4 border-t border-[var(--color-border)] pt-10">
        ...
        <p className="text-sm text-[hsla(var(--color-secondary)/1)]">
        ...
        <div className="pt-4 space-y-1">
          ...
          <p className="text-sm text-[hsla(var(--color-secondary)/1)]">Flow Health Team</p>
        </div>
      </div>
