    ...
    <main className="max-w-4xl mx-auto px-6 pt-20 pb-24 space-y-12">
            ...
            <tbody className="divide-y divide-ink/[12.5%]">
              {[
                ...
                <tr key={`${dest}-${value}`}>
                  ...
                  <td className="py-3 pr-6 text-sm font-semibold bg-gradient-to-r from-brand to-ink bg-clip-text text-transparent">{value}</td>
                  <td className="py-3 pr-6 text-base font-medium">{cost}</td>
                  <td className="py-3 text-sm font-semibold bg-gradient-to-r from-brand to-ink bg-clip-text text-transparent">{time}</td>
                </tr>
              ))}
            </tbody>
          </table>
      ...
      <div className="space-y-4">
        ...
        <ul className="space-y-2 text-sm font-semibold bg-gradient-to-r from-brand to-ink bg-clip-text text-transparent leading-relaxed">
          ...
          <li><span className="font-medium text-[rgb(30,24,84)]">Rest of World</span> → DHL Express or FedEx</li>
        </ul>
        <p className="text-sm font-semibold bg-gradient-to-r from-brand to-ink bg-clip-text text-transparent">All parcels are fully tracked and insured.</p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <ul className="space-y-2 text-sm font-semibold bg-gradient-to-r from-brand to-ink bg-clip-text text-transparent leading-relaxed">
          ...
          <li><span className="font-medium text-[rgb(30,24,84)]">EU / EEA</span> → Prices are shown excluding Swiss VAT. You may have to pay your local VAT + possible customs handling fees upon arrival (charged by courier).</li>
          <li><span className="font-medium text-[rgb(30,24,84)]">United Kingdom</span> → You will pay UK VAT + a small courier handling fee at checkout (IOSS registered). No surprise fees on delivery.</li>
          <li><span className="font-medium text-[rgb(30,24,84)]">USA, Canada, Rest of World</span> → You are responsible for all import duties, taxes, and customs brokerage fees. These are NOT included in the shipping cost and will be collected by the courier before delivery.</li>
        </ul>
        <p className="text-sm font-semibold bg-gradient-to-r from-brand to-ink bg-clip-text text-transparent">We are not liable for parcels held or refused due to unpaid duties/taxes.</p>
      </div>
