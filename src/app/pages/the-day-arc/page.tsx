      ...
      <article className="py-16 md:py-24">
        <div className="max-w-[760px] mx-auto px-6 space-y-14 text-sm text-[rgba(30,24,84,0.80)] leading-[1.85]">
          ...
          <section className="space-y-4">
            ...
            <p>
              That consistency is the point. A brain that moves through the day without borrowing against tomorrow is a brain that compounds: each good day makes the next one easier, and the arc gradually rises rather than gradually eroding.
            </p>
          </section>
