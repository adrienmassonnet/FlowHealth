  ...
  return (
    <main className="max-w-4xl mx-auto px-6 py-24 space-y-16">
      ...
      <div className="space-y-3">
        <p className="text-xs tracking-[0.14em] uppercase text-[hsla(var(--color-secondary)/1)]">Science-backed</p>
        <h1 className="text-4xl font-semibold tracking-[-0.02em]">Research</h1>
        <p className="text-base text-[hsla(var(--color-secondary)/1)] leading-relaxed max-w-xl">
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-[var(--color-border)]">
          {[
            ...
            <div key={item.label} className="bg-[#F8F8F8] p-6 space-y-2">
              <p className="text-2xl font-semibold tracking-[-0.02em]">{item.stat}</p>
              <p className="text-xs tracking-[0.1em] uppercase font-semibold text-[hsla(var(--color-secondary)/1)]">{item.label}</p>
              <p className="text-base text-[hsla(var(--color-secondary)/1)] leading-relaxed">{item.detail}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-px bg-[var(--color-border)]">
          {[
            ...
            <div key={study.ingredient} className="bg-[#F8F8F8] p-6 space-y-2">
              <p className="text-base font-semibold tracking-[-0.01em]">{study.ingredient}</p>
              <p className="text-base text-[hsla(var(--color-secondary)/1)] leading-relaxed">{study.finding}</p>
