...
export default function BrainHealthSection() {
  ...
  return (
    <section ref={sectionRef} className="flow-section bg-surface overflow-hidden">
      <div className="flow-container">
        <div className="flex flex-col md:flex-row md:items-center gap-10 md:gap-6">
          ...
          >
            ...
            <p className="flow-body">
              Flow was built for this. Through clinically studied adaptogens, nootropics, and the habits that let them work — it addresses the root causes of what chronic overstimulation does over months and years to stress, focus, mood, and sleep.
            </p>
          </motion.div>
