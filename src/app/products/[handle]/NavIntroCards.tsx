      ...
      >
        {CARDS.map((card) => (
          <button
            ...
            className="shrink-0 rounded-xl border border-[var(--color-border)] bg-white px-4 py-2.5 text-xs font-medium text-[#1E1854] hover:border-[#1E1854]/25 hover:bg-[#1E1854]/[0.04] transition-all duration-200 whitespace-nowrap"
          >
            {card.label}
          </button>
        ))}
