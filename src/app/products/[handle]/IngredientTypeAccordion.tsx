          ...
          <div key={cat.type}>
            ...
            >
              <div className="flex items-center gap-4">
                {cat.image && (
                  <div className="relative w-10 h-10 rounded-full overflow-hidden shrink-0 bg-ink/[5.9%]">
              ...
              <span
                className="font-semibold bg-gradient-to-r from-brand to-ink bg-clip-text text-transparent transition-transform duration-300 shrink-0"
            ...
            >
              <ul className="pb-5 space-y-1 pl-14">
                {cat.ingredients.map((ing) => (
                  <li key={ing} className="text-sm font-semibold bg-gradient-to-r from-brand to-ink bg-clip-text text-transparent flex items-center gap-2">
                    <span className="w-1 h-1 rounded-full bg-[rgba(30,24,84,0.5)] shrink-0" />
                    {ing}
                  </li>
                ))}
              </ul>
