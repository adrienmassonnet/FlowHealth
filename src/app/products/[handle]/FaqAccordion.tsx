          ...
          <div key={item.title}>
            ...
            >
              <div className="flex items-center gap-4">
                <span className="text-[rgb(30,24,84)] shrink-0 w-6 h-6 md:w-8 md:h-8 flex items-center justify-center [&>svg]:w-full [&>svg]:h-full">{item.icon}</span>
                <span className="text-sm font-medium tracking-[-0.01em]">{item.title}</span>
              </div>
              <span
                className="text-[rgb(30,24,84)] transition-transform duration-300 shrink-0"
            ...
            >
              <p className="pb-5 text-sm text-[rgb(30,24,84)] leading-[1.55] pl-10 md:pl-14">
                {item.content}
              </p>
            </div>
          </div>
