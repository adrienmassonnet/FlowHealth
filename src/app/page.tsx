          ...
          <div className="max-w-[1200px] mx-auto px-6 space-y-8 md:space-y-12">
            <div className="space-y-3 text-center max-w-[860px] mx-auto">
              <div className="space-y-4">
                ...
                <p className="text-base text-[#1E1854]/65 leading-[1.55] max-w-[620px] mx-auto">
                  Flow is more than a product — it's an investment in yourself, and a step closer to your goals.
                </p>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 max-w-[860px] mx-auto">
                {[
                  {
                  ...
                  <TrustCard key={card.title} delay={card.delay} className="border border-[#1E1854]/10 rounded-xl px-2.5 py-2.5 flex flex-row gap-2 items-center text-left shadow-[0_2px_12px_rgba(30,24,84,0.06)] bg-white">
                    <div className="text-[#3B38B8] shrink-0">{card.icon}</div>
                    <p className="text-xs font-semibold uppercase tracking-[0.06em] leading-snug bg-gradient-to-r from-[#3B38B8] to-[#1E1854] bg-clip-text text-transparent">{card.title}</p>
                  </TrustCard>
                ))}
              </div>
            </div>

            <div className="w-full flex flex-col md:flex-row gap-4 md:gap-14 items-stretch">
                ...
                <ul className="divide-y divide-[#1E1854]/8 bg-[#1E18540A] rounded-2xl px-4 shadow-[0_1px_6px_rgba(30,24,84,0.06)] border border-[#1E1854]/[0.05]">
                  {[
                    ...
                    <li key={label} className="flex items-baseline gap-4 py-2">
                      <span className="text-xs font-semibold text-[#1E1854]/30 w-14 md:w-16 shrink-0">{label}</span>
                      <span className="text-xs text-[#1E1854]/75 leading-[1.4]">{value}</span>
                    </li>
                  ))}
                </ul>
